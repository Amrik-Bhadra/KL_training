...
import { Button } from "@/presentation/components/ui/button"; // Adjusted path
import { Checkbox } from "@/presentation/components/ui/checkbox"; // Adjusted path
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogFooter,
  DialogClose,
} from "@/presentation/components/ui/dialog"; // FIX: All imports from one place
